...
public class Post_office implements Internal_Mail{
    ...
    @Override
    public void setNET(Post_office... offices) {
    ...
    {
        System.out.println("Почтовое отделение " + this.postName + " получила письмы: ");
